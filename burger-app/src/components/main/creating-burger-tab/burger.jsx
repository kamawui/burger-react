...
class Burger extends Component {
    ...
    render() {
        ...
        const {getActiveTab, ingredients, renderBurger, summaryData} = this.props;
            ...
            <div className={getActiveTab() === "burger" ? "burger" : "burger hidden"}>
                <div className="burger-content">
                    ...
                    <div className="summary">
                        <h2>{data.summaryLabels.header}</h2>
                        ...
                        <p>{data.summaryLabels.message.part1}
                        ...
                        <div className="total-info">
                            ...
                            <div className="weight">
                                <div className="time-icon">{data.summaryLabels.icons.weights}</div>
                                <span>{summaryData.oz} {data.summaryLabels.units.weight}</span>
                            </div>
                            <div className="calories">
                                <div className="time-icon">{data.summaryLabels.icons.fire}</div>
                                <span>{summaryData.kcal} {data.summaryLabels.units.calories}</span>
                            </div>
                        </div>
                    </div>
                </div>
